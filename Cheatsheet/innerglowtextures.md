...
- جایگاه,  
    - به جای هر value چی میتونیم بنویسیم ؟
- شکل
    - circle یا ellipse به معنای دایره و بیضی
- اندازه
    - مثلا برای circle : 40px یا 100% . نشون دهنده اندازه گرادینت گردی که ساخته میشه
    - مثلا برای ellipse : 40px 20px یا 50% 10% . نشون دهنده طول و عرض بیضی
- جایگاه 
    - استفاده از کلمه کلیدی مثل center top یا center یا left bottom . و یا تعریف جایگاه دقیق افقی . عمودی مثل 10% 20% که نشون دهنده فاصله از چپ و بالای المنت هست
- رنگ 
    - مثل بقیه رنگ ها
