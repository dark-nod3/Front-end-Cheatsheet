# چطوری داخل المنت افکت و الگو های گرادینت دار درست کنیم ؟
...
میشه تو این دو `property` همزمان به یک المنت چند استایل اعمال کرد
...
>مهم نیست که همه رو تو یک خط بنویسیم یا اینکه مثل مثال بالا. این سبک نوشتن فقط برای خوانایی بهتره.
...
چون به گرادینت ها سایز ندادیم به صورت پیش فرض به اندازه کل المنت هستن و ما با تایین ` % ` برای رنگ دوم (`transparent`) ، اندازه دایره های گرادینت دار رو کنترل کردیم.
>[!NOTE]
