...
---
#### 2) نحوه اعمال چند مقدار به یک المنت
...
>[!NOTE]
>نکته: بین `value` ها حتما باید از ` , ` (کاما | comma) استفاده کرد و در پایان از ` ; ` (سمیکالن | semicolon) استفاده کرد برای تایین اینکه اون `property` تموم شده.
